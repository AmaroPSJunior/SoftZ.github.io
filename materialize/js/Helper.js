...
var Helper = (function () {
    function init() {
        ...
        //var STATUS = document.querySelector('.posicionamentoBolinhaDoHeader');
        //var NOME_STATUS = document.querySelector('.headerNomeUsuarioPosicionamento');
        //window.setInterval(function () {
        //    var online = navigator.onLine;
        //    if (online) {
        //        STATUS.classList.remove('off-line');
        //        STATUS.classList.add('online');
        //        NOME_STATUS.textContent = 'online'
        //        //console.log('passei no ON');
        //        // console.log('Estamos onlline');
        //    } else {
        //        STATUS.classList.remove('online');
        //        STATUS.classList.add('off-line');
        //        NOME_STATUS.textContent = 'offline';
        //        //console.log('passei no OFF');
        //        //console.log('Estamos offiline');
        //    }
        //}, 5000);
